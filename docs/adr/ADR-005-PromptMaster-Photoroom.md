...
1. **Delegacja logiki do LLM:** Zamiast sztywnych szablonów, model LLM (`gemini-3.8-flash`, zarejestrowany jako Agent ID: 11) przejmuje zadanie wykreowania kreatywnego promptu w języku polskim, znając dane z bazy PIM oraz rodzaj slota (parzysty/nieparzysty).
