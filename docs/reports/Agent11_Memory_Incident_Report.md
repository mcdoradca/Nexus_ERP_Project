...
```javascript
1: { model: 'gemini-3.8-flash', ..., maxOutputTokens: 15000, timeoutMs: 120000 },
...
11: { model: 'gemini-3.8-flash', ..., maxOutputTokens: 5000 }
```

**Konsekwencje wdrożenia:**
Model sprzętowo oznaczony jako `gemini-3.8-flash` odrzucał polecenia posiadające `maxOutputTokens` wykraczające poza hard limit serwera Google (powodowało to blokady i 400 Bad Request w RAG oraz przy generowaniu dużych zrzutów tekstowych). 
...
```diff
- 1: { model: 'gemini-3.8-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 0, grounding: true, maxOutputTokens: 15000, timeoutMs: 120000 },
+ 1: { model: 'gemini-3.8-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 0, grounding: true },

- 11: { model: 'gemini-3.8-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 0.8, maxOutputTokens: 5000 }
+ 11: { model: 'gemini-3.8-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 0.8 }
```
