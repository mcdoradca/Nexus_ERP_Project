...
import { Calendar, Clock, Loader2, Save, Users, Plus, Trash2, CheckCircle, XCircle } from 'lucide-react';
                    ...
                    <div className="p-5 overflow-y-auto custom-scrollbar space-y-4">
                        ...
                        {bookings.map(b => (
                            <div key={b.id} className="p-5 border border-slate-200 rounded-xl hover:border-indigo-200 transition-colors bg-white shadow-sm">
                                ...
                                <div className="flex items-center text-indigo-600 text-xs font-black mb-4 bg-indigo-50 w-max px-3 py-1.5 rounded-lg">
                                    <Clock className="w-3 h-3 mr-2" />
                                    {new Date(b.meetingDate).toLocaleDateString()} o {b.startTime} ({b.durationMinutes} min)
                                </div>
                                {b.jobDescription && (
