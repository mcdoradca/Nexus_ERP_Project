...
const nodesConfig = {
    1: { model: 'gemini-3.1-pro-preview', temperature: 0, grounding: true },
    2: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MINIMAL, temperature: 0 },
    4: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 0 },
    5: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MEDIUM },
    6: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.LOW },
    7: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MEDIUM },
    ...
    11: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MEDIUM, temperature: 1.2 }
};
