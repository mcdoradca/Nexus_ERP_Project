...
const nodesConfig = {
    1: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.LOW, temperature: 0, grounding: true },
    ...
    11: { model: 'gemini-3.5-flash', thinkingLevel: ThinkingLevel.MINIMAL, temperature: 0.8, maxOutputTokens: 5000 }
};
