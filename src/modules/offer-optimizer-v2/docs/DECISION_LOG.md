...
[2026-07-30] | dokumentacja: nag≥Ûwki promptÛw v4 zawierajπ model i thinkingBudget | rzeczywistoúÊ: kompilat jest artefaktem generowanym, rÍczna edycja ginie przy rekompilacji; thinkingBudget = legacy (obowiπzuje thinkingLevel wg ß3A) | decyzja Architekta: parametry wywo≥ania wy≥πcznie w konfiguracji kodu, kompilator wycina je z nag≥ÛwkÛw, prompts/ = katalog generowany (zakaz edycji rÍcznej) | ryzyko: brak ó test z pkt f pilnuje.
