...
console.log("\n=== KROK 2: grep na isChemical/route_chemical ===");
try {
    const r = execSync('git grep -rnE "isChemical|is_chemical|route_chemical" -- "src/modules/offer-optimizer-v2"', {encoding: 'utf8'});
    console.log(r);
} catch(e) {
...
const extractFromFeatures = require('./src/modules/offer-optimizer-v2/baselinker.extract.js').extractFromFeatures;
const sampleTrimay = require('./src/modules/offer-optimizer-v2/tests/fixtures/trimay_pim_sample.json');
...
(async () => {
    ...
    // Equilibra
    try {
        const sampleEquilibra = require('./src/modules/offer-optimizer-v2/tests/fixtures/baselinker_product_8000137015436.json');
